// For more shaders like these download the excellent (and free!) HardSurface Shader pack from the Asset Store

Shader "Game/Ship Hull"
{
	Properties
	{
	...
	SubShader
	{
		...
		UsePass "Hidden/Ship Hull/FORWARD"
	} 
	Fallback "Diffuse"
}
